...
describe('habitService', function () {
    ...
    describe('updateHabit', function () {
        ...
        describe('invalid', function () {
            it('Should throw invalid weekday error', async function () {
                habitService.updateHabit(this.test.habit, { "dates": [new Date('Wed Sep 23 2020 13:31:16 GMT+0200')] }).should.be.rejectedWith(Error);
            });
        });
